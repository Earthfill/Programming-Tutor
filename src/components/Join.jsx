...
const Join = () => {
  return (
    <div className="align-element 2xl:mb-10 2xl:max-w-full 2xl:px-[22vw] my-4">
      <div className="bg-base-100 grid gap-4 md:gap-7 py-7 md:py-20 place-items-center rounded-md">
        <div className="text-4xl font-medium text-primary text-center md:mx-16 lg:mx-72 md:text-5xl md:tracking-wide">
